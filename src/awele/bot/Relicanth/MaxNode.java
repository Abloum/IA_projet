 ...
 */
public class MaxNode extends RelicanthNode
{
    /**
     ...
     */
    MaxNode (Board board, int depth, double alpha, double beta, int budget)
    {
    ...
    {
        return new MinNode(board, depth, alpha, beta, budget);
    }
