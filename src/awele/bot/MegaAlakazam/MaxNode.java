 ...
 */
public class MaxNode extends MegaAlakazamNode
{
    /**
     ...
     */
    MaxNode (Board board, int depth, double alpha, double beta, int dernierCoupJoue, int budget)
    {
    ...
    {
        return new MinNode(board, depth, alpha, beta, dernierCoupJoue, budget);
    }
