...
public class StrategeSansQIBot extends CompetitorBot
{
    /**
    ...
    public StrategeSansQIBot() throws InvalidBotException
    {
        this.setBotName ("Stratege sans QI");
